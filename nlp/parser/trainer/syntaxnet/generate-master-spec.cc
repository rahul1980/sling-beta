...
void OutputMasterSpec(Artifacts *artifacts) {
  ...
  string ff_spec_str =
      ...
      "} "
      "linked_feature { "
      "  name: 'lr_lstm' fml: 'input.focus' embedding_dim: 32 size: 1 "
      "  source_component: 'lr_lstm' "
      "  source_translator: 'identity' "
      "  source_layer: 'layer_0' "
      "} "
      "linked_feature { "
      "  name: 'rl_lstm' fml: 'input.focus' embedding_dim: 32 size: 1 "
      ...
      "linked_feature { "
      "  name: 'history' "
      "  fml: 'constant(0) constant(1) constant(2) constant(3)' "
      "  embedding_dim: 64 "
      "  source_component: 'ff' "
